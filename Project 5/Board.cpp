...
Player Board::executeEvent(int eventNumber, char tileColor, Player player, int playerPosition, int previousPosition) {
    switch (tileColor) {
        ...
        case 'B': // Oasis tile (Blue)
            cout << "You’ve found a peaceful oasis! You gain 200 Stamina, Strength, and Wisdom Points." << endl;
            player.setStamina(player.getStamina() + 200);
            player.setStrength(player.getStrength() + 200);
            player.setWisdom(player.getWisdom() + 200);
            break;

        case 'P': // Counseling tile (Pink)
            cout << "Welcome to the land of enrichment. Your Stamina, Strength, and Wisdom Points increase by 300." << endl;
            cout << "You may also choose or switch your advisor." << endl;
        ...
        case 'R': // Graveyard tile (Red)
            cout << "Uh-oh, you’ve stumbled into the Graveyard! You lose 100 Stamina, Strength, and Wisdom Points." << endl;
            ...
            playerPosition = max(0, playerPosition - 10);
            break;

        case 'N': // Hyenas tile (Brown)
            cout << "The Hyenas are on the prowl! You are dragged back to your previous position and lose 300 Stamina Points." << endl;
            player.setStamina(player.getStamina() - 300);
            playerPosition = previousPosition;
            break;

        case 'U': // Challenge tile (Purple)
            cout << "Time for a test of wits! Answer correctly to earn 500 Wisdom Points." << endl;
            // bool answeredCorrectly = true; // Replace with actual riddle logic
